...
public interface CodeGenerator {
	...
	public static String register(int reg) {
		...
		} else if (reg < GOOD_REGISTER_CNT) {
			return "R" + (reg + GOOD_REGISTER_CNT);
		} else {
			return "R" + (reg - GOOD_REGISTER_CNT);
		}
	}
	 ...
	 * the {@link #loopLabel() loop-label} will be added to the {@code alreadyUsed} {@link Set} if it is not already in it and if it is already there it will ignore this fact
	 * 
	 * @param ticks
	 *            the ticks of the loop to waste
	 * @param alreadyUsed
